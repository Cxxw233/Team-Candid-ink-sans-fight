...
eff.image_alpha=0;
easing_execute(eff,"image_alpha",CrTweenIs.Quad,CrEaseIs.InOut,0,+1,2);
easing_execute(eff,"image_alpha",CrTweenIs.Quad,CrEaseIs.InOut,1,-1,4,3);
}
}
}
}
